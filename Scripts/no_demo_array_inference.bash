...
# INPUT ARGUMENTS
prefix="../Data/no_demo_array/50_seed_${seed}" # Output prefix, and input prefix of given vcf
...
# INPUT ARGUMENTS
prefix="../Data/no_demo_array/100_seed_${seed}" # Output prefix, and input prefix of given vcf
...
# INPUT ARGUMENTS
prefix="../Data/no_demo_array/150_seed_${seed}" # Output prefix, and input prefix of given vcf
...
# INPUT ARGUMENTS
prefix="../Data/no_demo_array/200_seed_${seed}" # Output prefix, and input prefix of given vcf
...
# INPUT ARGUMENTS
prefix="../Data/no_demo_array/250_seed_${seed}" # Output prefix, and input prefix of given vcf
...
# INPUT ARGUMENTS
prefix="../Data/no_demo_array/300_seed_${seed}" # Output prefix, and input prefix of given vcf
