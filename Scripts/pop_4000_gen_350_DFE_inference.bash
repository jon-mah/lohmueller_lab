...
# INPUT ARGUMENTS
prefix="../Data/pop_4000_no_demo_no_shift/350_gen" # Output prefix, and input prefix of given vcf
...
# INPUT ARGUMENTS
prefix="../Data/pop_4000_no_demo_shift/350_gen" # Output prefix, and input prefix of given vcf
