...
prefix="../Data/no_demo_array_reduced/seed_${seed}" # Output prefix, and input prefix of given vcf
...
slim -d chrom=$SGE_TASK_ID -d init_seed=$seed no_demo_array_reduced_simulation.slim
