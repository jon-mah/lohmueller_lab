...
prefix="../Data/pop_2000_recap/seed_${seed}" # Output prefix, and input prefix of given vcf
...
slim pop_2000_recap_simulation

# If `SLiM` is not an executable, then uncomment the next line and
# provide a path to `SLiM`.
# ./slim -d chrom=$SGE_TASK_ID -d init_seed=$seed pop_2000_recap_simulation.slim
