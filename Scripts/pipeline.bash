...
then
  ...
  num_samples=($num_ind_1 * 2) + ($num_ind_2 * 2)
else
  num_samples=$num_ind_1 * 2
...
python fitdadi_infer_DFE.py ../Data/pilot_pipeline/easySFS_output/dadi/pop1.sfs ../Data/pilot_pipeline/fitdadi_output/ $num_samples

# python fitdadi_infer_DFE.py ../Data/fitdadi_manual_examples/example.sfs ../Data/fitdadi_example_output/
